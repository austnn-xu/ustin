...
/**
 * Object catalog. `match` terms are free-text aliases for search and for any
 * caller that arrives with a label rather than an id; keeping them here means
 * this file stays the single source of truth for what US Tin knows about.
 */
const OBJECTS = [
  {
    id: 'pizza-box',
